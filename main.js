...
navigator.geolocation.getCurrentPosition((position) => {
    ...
    fetch(url)
        ...
        .then((json) => {
            ...
            header.innerHTML = `${json.location.localtime.split(' ')[0]}<br><br>${json.location.name}
            <img src="icons/Status-weather-clouds-icon.png"></img><br>temp:&nbsp;&nbsp;
            ${json.current.temp_c}°C<br>${json.current.condition.text}`
